...
export function AuthShell({
  ...
  return (
    <main className="min-h-[100svh] bg-[#f3efff] text-[#17182c] sm:px-5 sm:py-5 lg:flex lg:items-center lg:justify-center lg:px-8 lg:py-8">
      <section className="relative mx-auto flex min-h-[100svh] w-full max-w-[460px] flex-col overflow-hidden bg-[linear-gradient(180deg,#e7dcff_0%,#f7f4ff_31%,#ffffff_100%)] shadow-[0_22px_70px_rgba(80,48,150,0.14)] sm:min-h-[calc(100svh-2.5rem)] sm:rounded-[22px] lg:grid lg:min-h-[680px] lg:max-w-[1040px] lg:grid-cols-[0.92fr_1.08fr] lg:bg-[linear-gradient(110deg,#e4d8ff_0%,#f5f1ff_49%,#ffffff_100%)]">
        {backHref ? (
        ...
        <div className="relative h-[196px] shrink-0 overflow-hidden px-6 pt-[78px] sm:h-[210px] sm:px-7 sm:pt-[86px] lg:h-auto lg:min-h-full lg:px-10 lg:pt-28">
          ...
          <div className="absolute -right-7 top-3 h-[190px] w-[230px] opacity-95 sm:right-0 sm:w-[245px] lg:-bottom-2 lg:-right-10 lg:top-auto lg:h-[470px] lg:w-[520px]">
            <Image
              src="/wash_fold.png"
              alt=""
              fill
